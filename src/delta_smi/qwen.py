...
# model_before_path = "Qwen/Qwen2.5-0.5B"
...
for lang in path:
    print(lang)
    # model_after_path = f"{main_path}/data/multi-18-10steps-qwen2.5-0.5b/{lang}"
...
print(cosine_sim)
# torch.save(cosine_sim, f'{main_path}/data/multi-18-10steps-qwen2.5-0.5b-matrix/cosine_sim_10_last3.pt')
torch.save(cosine_sim, f'{main_path}/data/multi-18-10steps-qwen2.5-1.5b-matrix/cosine_sim_10_last3.pt')

# convert the cosine similarity to the distance
cosine_dist = 1 - cosine_sim
print(cosine_dist)
# torch.save(cosine_dist, f'{main_path}/data/multi-18-10steps-qwen2.5-0.5b-matrix/cosine_dist_10_last3.pt')
torch.save(cosine_dist, f'{main_path}/data/multi-18-10steps-qwen2.5-1.5b-matrix/cosine_dist_10_last3.pt')
